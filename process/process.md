...
总结：没有具体指明涉及什么信息算隐私泄露。但结合个人信息描述写出如下信息：

身份证：姓名+身份证号、姓名+住址、姓名+本人相片；军官证：姓名+军官证号、姓名+本人相片、姓名+部队；护照：姓名+护照号、姓名+本人相片；驾驶证：姓名+住址、姓名+驾驶证号码、姓名+本人相片；工作证：姓名+单位、姓名+本人相片；社保卡：姓名+号码、姓名+本人相片；居住证：姓名+号码、姓名+本人相片、姓名+地址
